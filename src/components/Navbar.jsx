    ...
    <nav className="w-full sticky top-0 z-50">
      ...
      <div className="bg-white border-b border-blue-100 shadow-sm">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          {/* Logo and Title */}
          <a href="#home" onClick={scrollToTop} className="flex items-center gap-4 cursor-pointer hover:opacity-80 transition-opacity">
            <div className="auristra-logo">
            ...
            <div>
              <h1 className="text-blue-900 text-2xl font-bold tracking-tight">AURISTRA</h1>
              <p className="text-blue-600 text-sm tracking-widest font-medium">VENTURES</p>
            </div>
          </a>
      ...
      {/* Bottom Navigation */}
      <div className="bg-gradient-to-r from-blue-800 to-blue-900 text-white shadow-md">
