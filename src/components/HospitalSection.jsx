...
export default function HospitalSection() {
  return (
    <section id="hospital-equipment" className="py-16 bg-gradient-to-b from-white to-blue-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-blue-900 mb-4">Hospital Instruments & Equipment</h2>
