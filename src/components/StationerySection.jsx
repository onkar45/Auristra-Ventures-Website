import { officeStationery } from '../data/products';

export default function StationerySection() {
  return (
    <section id="office-stationery" className="py-16 bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-blue-900 mb-4">Office & Institutional Stationery</h2>
          <div className="w-20 h-1 bg-blue-600 mx-auto mb-4"></div>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Complete stationery solutions for offices and institutions
          </p>
        </div>
